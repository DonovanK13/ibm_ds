...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Launch Success Rate for All')
        return fig
    else:
        launch_suc_val  = filtered_df.loc[filtered_df['Launch Site'] == entered_site,'class'].item()
        launch_fail_val = 1-launch_suc_val
        fig  = px.pie(values = [launch_suc_val, launch_fail_val], 
        names= entered_site, title = 'Launch Success Rate'+entered_site)
        return fig 
